/* eslint-disable */
// TAB: Analytics
// This file contains the Analytics tab JSX, extracted from App.js
        ...
        {tab==="Analytics"&&isAdmin&&(()=>{
          ...
          const inAnlRange=date=>{if(!anlFrom)return true;const d=new Date(date+"T00:00:00");return d>=anlFrom&&d<=anlTo;};
